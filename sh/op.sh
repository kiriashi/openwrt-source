...
git_sparse_clone 25.12 https://github.com/chasey-dev/immortalwrt-mt798x-rebase package/firmware/linux-firmware
git_sparse_clone 25.12 https://github.com/chasey-dev/immortalwrt-mt798x-rebase package/kernel/linux/modules
...
curl -s https://raw.githubusercontent.com/chasey-dev/immortalwrt-mt798x-rebase/25.12/package/kernel/linux/files/sysctl-nf-conntrack.conf > package/kernel/linux/files/sysctl-nf-conntrack.conf
